...
/// Deterministic demo data client used by the screenshot-only entrypoint.
/// It serves fake (non-sensitive) data so the public README screenshots never
/// expose real keys, costs, IPs or users.
